...
#define NEC_ADDRESS_BITS 
#define NEC_COMMAND_BITS 
...
#define NEC_RX_PROLOGUE_SILENCE_MIN_US 
#define NEC_RX_PROLOGUE_SILENCE_MAX_US 
#define NEC_RX_PROLOGUE_PULSE_MIN_US 
#define NEC_RX_PROLOGUE_PULSE_MAX_US 

#define NEC_RX_SYMBOL_SILENCE_MIN_US 
#define NEC_RX_SYMBOL_SILENCE_MAX_US 
#define NEC_RX_SYMBOL_0_PULSE_MIN_US 
#define NEC_RX_SYMBOL_0_PULSE_MAX_US 
#define NEC_RX_SYMBOL_1_PULSE_MIN_US 
#define NEC_RX_SYMBOL_1_PULSE_MAX_US 
